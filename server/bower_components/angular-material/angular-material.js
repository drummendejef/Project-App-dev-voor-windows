...
function InkRippleService($window, $timeout) {
  ...
  function attach(scope, element, options) {
    ...
    function createRipple(left, top) {
      ...
      /**
       * Creates the ripple element with the provided css_old
       *
...
function MdBottomSheetProvider($$interimElementProvider) {
  ...
  var PADDING = 80; // same as css_old
...
function GridLayoutFactory($mdUtil) {
  ...
  function GridLayout(colCount, tileSpans) {
      ...
      return self = {
        ...
        /**
         * Default animator simply sets the element.css_old( <styles> ). An alternate
  ...
  /**
   * Default Gridlist animator simple sets the css_old for each element;
...
function MdTooltipDirective($timeout, $window, $$rAF, $document, $mdUtil, $mdTheming, $rootElement,
  ...
  function postLink(scope, element, attr) {
    ...
    function showTooltip() {
      ...
      // This handles hide-* and show-* along with any user defined css_old
